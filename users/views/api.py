...
from ..serializers import UserSerializer, UserCreateSerializer, UserTokenObtainPairSerializer
...
class UserRegistrationView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if serializer.validated_data.get('user_type') == 'ADMIN' and request.user.user_type != 'ADMIN':
                return Response(
